...
public class C04_SwitchCase {
    public static void main(String[] args) {
        ...
        System.out.println("Sali :      2");
        System.out.println("Carsamba :  3");
        System.out.println("Persembe :  4");
        System.out.println("Cuma :      5");
        System.out.println("Cumartesi : 6");
        System.out.println("Pazar :     7");
