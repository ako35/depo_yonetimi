...
public class C02_LocalDateTime {
    public static void main(String[] args) {
        ...
        LocalDate dogVeli=LocalDate.of(1993,Month.SEPTEMBER,15).minusYears(24).
        ...
        DateTimeFormatter dtf=DateTimeFormatter.ofPattern("HH:mm");// Saat:(24 saat uzerinden istiyorsak H,
                                                                        // 12 saat duzeninde istiyorsak h)
